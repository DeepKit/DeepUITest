...
> 定义 DeepFlow 的身份认证、授权控制、Prompt 安全、沙箱隔离与审计追踪机制�?
>
> 总体安全与数据权限框架以 `08.01.Quality-DeepFlow-安全与数据权限策�?v1.0.md` 为准，本篇聚�?*具体安全机制与实现建�?*�?
...
- 消息签名格式参考《DeepFlow-消息协议规范.md�?
- 权限检查在《DeepFlow-接口契约定义.md》的 IGuard 接口中实�?
- 安全错误码定义在《DeepFlow-错误处理策略.md�?
- 安全事件记录通过《DeepFlow-内部角色职能、边界与分工.md》中的记录员实现
- 生产环境安全配置参考《DeepFlow-部署架构.md�?
