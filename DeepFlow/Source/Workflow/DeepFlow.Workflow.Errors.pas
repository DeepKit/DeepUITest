...
const
  ...
  // === Skill 调用错误 ===
  ERR_SKILL_CALL_FAILED = 'DeepFlow/Skill/CallFailed';

  // === HTTP 调用错误 ===
  ERR_HTTP_CALL_FAILED = 'DeepFlow/HTTP/CallFailed';

  // === Script 调用错误 ===
  ERR_SCRIPT_CALL_FAILED = 'DeepFlow/Script/CallFailed';
  ...
  ERR_GUARD_EXPRESSION = 'DeepFlow/Guard/Expression';
...
begin
  ...
  AddMessage(ERR_SKILL_NOT_FOUND, ecConfiguration, esError,
    ...
    'Skill 未找到', '指定的Skill 未注册。',
    '请注册Skill 或检查Skill ID 是否正确。',
