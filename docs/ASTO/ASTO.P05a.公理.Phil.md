...
> 上述"原子性产出物网络"并非纯粹的理论构造。它直接提炼自 **DeepDev**——一个 AI 原生软件工厂的工程实践。在 DeepDev 中：
...
>
> ASTO 的公理体系与 DeepDev 的工程实践之间的映射关系，为"从工程实践中提炼哲学框架"这一方法论路径提供了可追溯的经验证据。详见 08-02.DeepDev-ODD-输出驱动开发方法论探讨-人类.md。
...
> **公理层级速查**：核心（体系最小自治循环：零→一→二→三→六）· 次核心（重要延伸：四/五）· 辅助（专化场景延伸）· 派生（可从上位公理推出）

> **说明**：以下部分保留“公理”命名以兼容历史版本，但其中的 `公理 1.5` 与 `引理 8.1` 应读作**派生命题**，不是奠基层公设。

### **公理负一：语言局限性公理 (Axiom of Linguistic Limitation)** [辅助]
...
### **公理零：环境熵增公理 (Axiom of Environmental Fluctuation)** [核心]
...
### **公理一：属集切片公理 (Axiom of Attribute-Set Mode Homeostasis)** [核心]
> **"存在，即是在噪声海中维持低熵孤岛。"**
...
### **公理 1.5：认识论二元与介入性三元定理 (Theorem of Epistemological Dualism & Interventional Triad)** [辅助]
> **"二元是观看的代价，三元是改造的路径。"**
...
### **公理二：属性分层公理 (Axiom of Attribute Stratification)** [核心]
...
### **公理三：合规性传递公理 (Axiom of Compliance Transmission)** [核心]
...
### **公理四：动变性场域公理 (Axiom of Motility Field)** [次核心]
...
### **公理 4.5：涌现公理 (Axiom of Emergence)** [辅助]
...
### **公理五：属集自指公理 (Axiom of Attribute-Set Mode Self-Reference)** [次核心]
...
### **公理六：规范跃迁公理 (Axiom of Normative Transition)** [核心]
...
### **公理七：不可约性公理 (Axiom of Irreducibility)** [辅助]
...
### **公理八：实践回路公理 (Axiom of Practice Loop)** [辅助]
...
#### **引理 8.1：认知不对称引理 (Lemma of Cognitive Asymmetry)** [派生]
...
### **公理九：内在张力公理 (Axiom of Internal Tension)** [辅助]
...
### **公理十：观察者效应公理 (Axiom of Observer Effect)** [辅助]
...
### **公理十二：悖论熔断公理 (Axiom of Paradox Circuit-Breaker)** [辅助]
...
### **公理十三：存在连续性公理 (Axiom of Existential Continuity)** [辅助]
...
### **公理十四：伦理注意力稀缺公理 (Axiom of Ethical Attention Scarcity)** [辅助]
